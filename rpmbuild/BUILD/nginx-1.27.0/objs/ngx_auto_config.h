#define NGX_CONFIGURE " --prefix=/usr --sbin-path=/usr/sbin/nginx --conf-path=/etc/nginx/nginx.conf --pid-path=/var/run/nginx.pid --lock-path=/var/lock/nginx.lock --http-log-path=/var/log/nginx/access.log --error-log-path=/var/log/nginx/error.log --with-http_ssl_module --with-http_dav_module --with-http_xslt_module --with-http_gzip_static_module --with-http_geoip_module --with-http_image_filter_module --with-http_auth_request_module --with-http_v2_module --with-http_v3_module --with-threads --with-stream --with-stream_ssl_module --with-file-aio --with-http_perl_module --with-perl_modules_path=/usr/lib64/perl5/vendor_perl --with-perl=/usr/bin/perl --with-cc-opt=-I/usr/local/include --with-ld-opt=-L/usr/local/lib --add-module=/root/rpmbuild/BUILD/nginx-1.27.0/nginx-dav-ext-module --add-module=/root/rpmbuild/BUILD/nginx-1.27.0/headers-more-nginx-module"
...
#define NGX_PERL_MODULES  (u_char *) "/usr/lib64/perl5/vendor_perl"
#endif
